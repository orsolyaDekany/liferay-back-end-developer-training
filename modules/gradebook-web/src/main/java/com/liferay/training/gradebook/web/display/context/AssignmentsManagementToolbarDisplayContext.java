 ...
 *
 * This class passes contextual information to the user interf ace for the Clay
 * management toolbar. *
 * 
 * @author liferay
 */
public class AssignmentsManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {
	...
	public CreationMenu getCreationMenu() {
		...
		if (!AssignmentTopLevelPermission.contains( _themeDisplay.getPermissionChecker(), _themeDisplay.getScopeGroupId(), "ADD_ENTRY")) {
		        return null;
	    }
	...
	/**
	 * Returns the assignment list display style. * Current selection is stored in
	 * portal preferences. *
	 * 
	...
	*/
    ...
    public List<ViewTypeItem> getViewTypeItems() {
		...
		portletURL.setParameter("orderByCol", orderByCol); portletURL.setParameter("orderByType", orderByType);
		int cur =
