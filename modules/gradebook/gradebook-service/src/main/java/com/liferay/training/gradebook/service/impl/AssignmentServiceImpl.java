...
public class AssignmentServiceImpl extends AssignmentServiceBaseImpl {
	...
	assignmentLocalService.getAssignmentsCountByKeywords(groupId, keywords);
	}
	...
	public Assignment updateAssignment(long assignmentId, Map<Locale, String> titleMap,
		...
		// Check permissions.
		_assignmentModelResourcePermission.check(getPermissionChecker(), assignmentId, ActionKeys.UPDATE);
